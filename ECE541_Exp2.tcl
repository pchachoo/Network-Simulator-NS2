...
set nf [open ECE541_Exp26.nam w]

$ns namtrace-all $nf

 

set nd [open ECE541_Exp26.tr w]
...
proc finish {} {
	...
	exec awk -f ECE541_1.awk ECE541_Exp26.tr > ECE541_Exp26X.tr 
	#get total number of packets and packets lost
	exec awk -f ECE541_2.awk ECE541_Exp26.tr > ECE541_Exp26P.tr 
